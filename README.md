...
- src/
  ...
  - scripts/
    ...
    - ...
  - reports/
    - data/ -> here you will find all drives and painpoints identified from task 4
    - figures/ -> all plots and figures like word clouds for each bank placed here
      insights.md -> insightful data that can be used to write reports placed here.
- sql/
